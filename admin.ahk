...
!7::
    ClickComponent("input")
    SendInput, ????????? ?????, ?????????? ????????? ???????{!} ??????: ????????? ???????? ?? ??? ???????? ??? ????????????? ? ?? (???????? ?? ?? ? ?????? ????????????). ???? ?? ???????? - ?????????? ?????????????? ??????? ??? ????????? ???????? ?? ?????? ??????????, ???? ??????? ??????? (??? ????? ?? ????????? - ???????? ? ??? ???????????? ??????????? ?????????, ????????? ???????? ? ?????? ?????? ????????? ?? ??????? ??????????? - ??? ?????{!}). ?????? (??? ????????????? Windows): ????????? ????????? ????????? ? ‘?????? ??????????? ??????’ ??? ???????? ? ?? ????????? (???? ? ??? ?????? ?? (???????????? ???????), ?? ?????????? ?????? ?????). ??? ???????? ?????? ??????? ? ????????? Windows (?????? ???? - ?????????? (??? Win10)) - ????????? ????? - ??????????????? ????????? - ?????? ?????????? ?????? - ?????? - ????? ???? ???????? ? ????????? ?????? ??????? ???? ?? ???????? ? ??? - ???????????? ?? ????????? & ???????????? ?????????? ????? ?? ?????????. ???? ???? ????????: ???????? ? ??????? ????????? ??? ??????? F3 ??? ???????????? ?????????? ????, ????? - ????????? ??? ????????. ??????: ??? ??????? ???? ????? RAGE Multiplayer Launcher ????????? ? ?????? ????????? (?????????? ? ???? ?????? ?????? ??? ‘??????????’, ???????? ?? ???????????? ????????) ? ????????? ??????? ?? ??? ???????? ? ??????? ?????????? ????, ? ??? ?? ?????? ?? ?????? ?? ???? ????????? ????????? ????????????????? ????????? ? ??????? ‘?????????? ?????’. ?????: ?? ???? ?? ??????? ?? ?????? - ?????????? ?????????? ? ??? ?????? ?? ?????? ??????? ??? ????? ????????? ?????????? (forum.gta5rp.com - ??????????? ?????? - Del Perro |  ??????????? ??????); ?????????? - ?????? ??? ????{!}
return
...
!Numpad5::
    ClickComponent("input")
    Sendinput, ??????? ???????????? ????????? ?? ?????????? ????? ?????. ? 13.08 ? 20:00 ?? 16.08 20:00 
return

; ????????????? ?? ??????
!Numpad4::
    ClickComponent("input")
Sendinput, ????????????? ?? ????????? ???????? ??? ???????? ?????????/????????? ??????/?????????, ?????? ??????????? ? ? ?????? ?????? ???????? ?????? ?? ?????. | forum.gta5rp.com
return

; ========================== ???? ????????? ===========================

::pg+::
    SendInput,prison  30 6.7 ?????? ???????{left 22}
return

::nrd+::
    SendInput,prison  20 6.2 ?????? ???????{left 18}
return

::nsp+::
    SendInput,mute  20 5.18 ?????? ???????{left 23}
return

::zap+::
    SendInput,mute  10 5.17 ?????? ???????{left 23}
return

::ooc+::
    SendInput,mute  20 5.3 ?????? ???????{left 22}
return

::dm+::
    SendInput,prison  20 6.9 ?????? ???????{left 22}
return

::oskr+::
    SendInput,ban  30 5.5 ?????? ???????{left 22}
return

::db+::
    SendInput,prison  20 6.3 ?????? ???????{left 22}
return

::dob+::
    SendInput,prison  40 6.20 ?????? ???????{left 23}
return

::amo+::
    SendInput,prison  40 6.14 ?????? ???????{left 23}
return

::lut+::
    SendInput,prison  40 6.19 ?????? ???????{left 23}
return

::cbm+::
    SendInput,prison  40 6.31 ?????? ???????{left 23}
return

::bg+::
    SendInput,prison  30 6.16 ?????? ???????{left 23}
return
...
::rk+::
    SendInput, prison  40 6.4 ?????? ???????{left 22}
return

::uho+::
    SendInput, prison  100 6.23 ?????? ???????{left 24}
return

; =========================== Warns in PM ==================

::pmnrd+::
    SendInput, pm  ?? ????????? ?????????? ????? 6.2 ?????? ??????? (NonRP Drive){!}{left 64}
return

::pmooc+::
    SendInput, pm  ?? ?????????? ?? OOC ? IC{!}{left 27}
return
...
::pmsp+::
    SendInput, pm  ???????????? ?????????? ????????????? ????????? SoundPad ? ?????? ????????? Discord: j1isa{left 91}
return

::pmna+::
    SendInput, pm  ???????????? ?????????? ????????????? ?????? ???????? ? ?????? ????????? Discord: j1isa{left 88}
return
...
::????+::
ClickComponent("input")
  Sendinput, ???????? ? ??????????, ?????????? ? ??????, ??????? ?????????? ?????????, ??? ????? ???? ??? ??? ????? ????? ? ??????? ??????????. ???????? ? ??????, ??? ????? ????????? ????, ??? ????? ???????? ? ?????????? ?? ????? ?????????? ??????? Ctrl, ???? ???? ?? ??????????, ???? ???? ?? ????????? ?????????? ????? ?? ????. ??? ?????? ???? ?????????, ?????? ????? ?????????. ????? ??????? ?????? ?? ??????????, ???????? ? ?????????? ??????? Shift. ????? ???? ??? ??????????? ???? ? ?????? ????? ??????? H ????? ???????? ????. {enter}
Return

::??+::
ClickComponent("input")
  Sendinput, BonusPoint ??????????? ?? ???????????? ????????. ????????: ?????????????? ? ??????? ????????, ??????? ? ????????? ????????, ?????? ?? ???????? ? ??????. ?????????? ?????? ?? ??????????.
Return
