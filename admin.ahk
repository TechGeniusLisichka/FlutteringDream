...
CheckAFK:
    ...
    if (currX = prevX && currY = prevY)
    {
        ...
        if (AFKTimer >= AFKTimeLimit)
        {
            ...
            SendInput, ~
            MsgBox, 0, Attention, Вы были AFK в течение %AFKTimeLimit% минут. Я любезно Вас кикнул из GTA., 5
        }
    }
    else
    {
    ...
    AFKTimer := 0 ; Обнуление AFKTimer перед завершением
    return
...
!2::
    ClickComponent("input")
    SendInput, Уважаемый игрок, проследила за указанной ситуацией, но нарушений заметить не удалось{!} Пожалуйста, если у Вас есть видеофиксация нарушения, то обратитесь на Форум в раздел Жалобы на игроков{!}
return
